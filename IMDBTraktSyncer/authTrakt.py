...
def authenticate(client_id, client_secret, refresh_token=None):
    ...
    if refresh_token:
        ...
        # After the user grants authorization, they will be redirected back to the
        # redirect URI with a temporary authorization code.
        # Extract the authorization code from the URL and use it to request an access
        # token from the Trakt API.
